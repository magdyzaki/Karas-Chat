...
class HomePage(QWidget):
    def __init__(self):
        ...
        self.desc.setStyleSheet("color: #444;")
        ...
        self.datetime_label.setStyleSheet("color: #333; padding: 4px;")
        self.runtime_label.setStyleSheet("color: #555; padding: 4px;")
        ...
        self.signature_label.setStyleSheet("color: #666; margin-top: 8px; margin-bottom: 8px;")
