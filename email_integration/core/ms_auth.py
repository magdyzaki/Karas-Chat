...
import pickle
import requests
from .ms_graph_config import CLIENT_ID, AUTHORITY, SCOPES, TOKEN_CACHE_PATH
...
def acquire_token_for_account(account_name, token_cache_path):
    """الحصول على token لحساب محدد"""
